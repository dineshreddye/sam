  ...
  setAnalyticsTag() {
    return {
      ...
      window.addEventListener('load',function(){
        for(var i=0;i<document.querySelectorAll('[href*="//www.toasttab.com/samudhrausa/v2/online-order"]').length;i++)
    {
       document.querySelectorAll('[href*="//www.toasttab.com/samudhrausa/v2/online-order"]')[i].onclick = function(){
              gtag('event', 'conversion', {
            'send_to': 'AW-716411674/FcwwCMKa9bcBEJqmztUC',
            'transaction_id': ''
        });
      });
      `
  ...
  render() {
    ...
    return (
      <Wrapper showImage={showImage}>
        ...
        <script dangerouslySetInnerHTML={this.setAnalyticsTag()} />
      </Wrapper>
    );
  }
}
